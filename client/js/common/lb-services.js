  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Instrument.owner() instead.
        "::get::Instrument::owner": {
          url: urlBase + "/Instruments/:id/owner",
          method: "GET"
        },
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Subject.instrument() instead.
        "::get::Subject::instrument": {
          url: urlBase + "/Subjects/:id/instrument",
          method: "GET"
        },
      }
    );
    ...
    */
    R.modelName = "Instrument";
        ...
        /**
         * @ngdoc method
         * @name lbServices.Instrument#owner
         * @methodOf lbServices.Instrument
         *
         * @description
         *
        ...
        R.owner = function() {
          ...
          var action = TargetResource["::get::Instrument::owner"];
          return action.apply(R, arguments);
        };
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    ...
    */
    R.modelName = "Subject";
        ...
        /**
         * @ngdoc method
         * @name lbServices.Subject#instrument
         * @methodOf lbServices.Subject
         *
         * @description
         *
        ...
        R.instrument = function() {
          ...
          var action = TargetResource["::get::Subject::instrument"];
          return action.apply(R, arguments);
        };
